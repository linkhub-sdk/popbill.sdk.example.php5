            ...
            <fieldset class="fieldset1">
                ...
                <ul>
                    ...
                    ?>
                            ...
                            <li>invoicerCEOName (공급자 대표자 성명) : <?php echo $result->invoicerCEOName  ?> </li>
                            ...
                            <li>invoicerSMSSendYN (공급자 알림문자 전송 여부) : <?php echo $result->invoicerSMSSendYN ? 'true' : 'false' ?> </li>

                            <li>invoiceeMgtKey (공급받는자 문서번호) : <?php echo $result->invoiceeMgtKey  ?> </li>
                            <li>invoiceeType (공급받는자 유형) : <?php echo $result->invoiceeType ?>  </li>
                            ...
                            <li>invoiceeSMSSendYN (공급받는자 알림문자 전송 여부) : <?php echo $result->invoiceeSMSSendYN  ? 'true' : 'false'  ?> </li>
