...
<?php
	...
	$Taxinvoice->writeDate = '20160707';		# [필수] 작성일자, 형식(yyyyMMdd) 예)20150101
	...
	$Taxinvoice->invoicerTaxRegID = '1234';						# 공급자 종사업장 식별번호
	$Taxinvoice->invoicerAddr = '주소';
	$Taxinvoice->invoicerBizClass = '업종';
	$Taxinvoice->invoicerBizType = '업태';
	...
	$Taxinvoice->invoiceeTaxRegID = '1234';
	$Taxinvoice->invoiceeAddr = '공급받는자 주소';
	$Taxinvoice->invoiceeBizClass = '업종';
	$Taxinvoice->invoiceeBizType = '업태';
...
#	$Taxinvoice->originalTaxinvoiceKey = '201502028888888800000001';
	...
	$Taxinvoice->detailList[0]->purchaseDT = '20160707';	# 거래일자
	...
	$Taxinvoice->detailList[0]->supplyCost = '';		# 공급가액
	$Taxinvoice->detailList[0]->tax = '';				# 세액
	...
	try {
		$result = $TaxinvoiceService->RegistIssue($testCorpNum, $Taxinvoice, $testUserID, $writeSpecification, $forceIssue, $memo, $emailSubject, $dealInvoiceMgtKey);
		$code = $result->code;
