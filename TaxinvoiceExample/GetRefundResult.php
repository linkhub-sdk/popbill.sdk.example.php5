...
/**
 * 환불 신청의 상태를 확인합니다.
 * - https://developers.popbill.com/reference/taxinvoice/php/api/point#GetRefundResult
 */
...
try {
    $result = $TaxinvoiceService->GetRefundResult($testCorpNum, $RefundCode, $testUserID);
