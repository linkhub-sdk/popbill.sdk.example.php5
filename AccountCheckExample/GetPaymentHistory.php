...
<?php
    /**
     * 포인트 결제내역을 확인합니다.
     * - https://docs.popbill.com/accountcheck/php/api#GetPaymentHistory
     */
    ...
    try	{
        $result = $AccountCheckService->getPaymentHistory($testCorpNum, $SDate, $EDate, $Page, $PerPage);
    }
                    ...
                    ?>
                                <fieldset class="fieldset2">
                                    ...
                                    <ul>
                                        ...
                                        <li>productName (정액제 상품명) : <?php echo $result->list[$i]->productName ?></li>
