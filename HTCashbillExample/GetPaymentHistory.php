...
<?php
     ...
     * - https://developers.popbill.com/reference/htcashbill/php/common-api/point#GetPaymentHistory
     */
    ...
    try	{
        $result = $HTCashbillService->getPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
    }
