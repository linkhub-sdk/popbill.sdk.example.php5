...
<?php
     ...
     * - https://developers.popbill.com/reference/htcashbill/php/common-api/point#PaymentRequest
     */
    ...
    try {
        $result = $HTCashbillService->PaymentRequest($CorpNum, $paymentForm, $UserID);
        $code = $result->code;
