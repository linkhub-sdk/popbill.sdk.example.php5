...
<?php
     ...
     * - https://developers.popbill.com/reference/htcashbill/php/common-api/point#GetUseHistory
     */
    ...
    try	{
        $result = $HTCashbillService->getUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
    }
