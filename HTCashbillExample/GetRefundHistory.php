...
<?php
     ...
     * - https://developers.popbill.com/reference/htcashbill/php/common-api/point#GetRefundHistory
     */
    ...
    try	{
        $result = $HTCashbillService->getRefundHistory($CorpNum, $Page, $PerPage, $UserID);
    }
