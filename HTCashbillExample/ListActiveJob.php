...
<?php
    ...
    try {
        $result = $HTCashbillService->ListActiveJob($CorpNum, $UserID);
    }
                            ...
                            for ($i = 0; $i < Count($result); $i++) {
                                ...
                                <fieldset class="fieldset2">
                                    ...
                                    <ul>
                                        ...
                                        <li>queryType (현금영수증 유형) : <?php echo $result[$i]->queryType ?></li>
                                        <li>queryDateType (수집 일자 유형) : <?php echo $result[$i]->queryDateType ?></li>
                                        <li>queryStDate (시작일자) : <?php echo $result[$i]->queryStDate ?></li>
                                        <li>queryEnDate (종료일자) : <?php echo $result[$i]->queryEnDate ?></li>
                                        <li>errorCode (수집 결과코드) : <?php echo $result[$i]->errorCode ?></li>
                                        ...
                                        <li>collectCount (수집건수) : <?php echo $result[$i]->collectCount ?></li>
