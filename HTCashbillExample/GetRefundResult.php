...
/**
 * 환불 신청의 상태를 확인합니다.
 * - https://developers.popbill.com/reference/htcashbill/php/api/point#GetRefundResult
 */
...
try {
    $result = $HTCashbillService->GetRefundResult($testCorpNum, $RefundCode, $testUserID);
