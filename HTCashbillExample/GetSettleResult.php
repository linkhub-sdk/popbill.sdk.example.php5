...
<?php
     ...
     * - https://developers.popbill.com/reference/htcashbill/php/common-api/point#GetSettleResult
     */
    ...
    try {
        $result = $HTCashbillService->GetSettleResult($CorpNum, $settleCode, $UserID);
    }
