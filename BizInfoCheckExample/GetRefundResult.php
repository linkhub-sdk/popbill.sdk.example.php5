...
/**
 * 환불 신청의 상태를 확인합니다.
 * - https://developers.popbill.com/reference/bizinfocheck/php/api/point#GetRefundResult
 */
...
try {
    $result = $BizInfoCheckService->GetRefundResult($testCorpNum, $RefundCode, $testUserID);
