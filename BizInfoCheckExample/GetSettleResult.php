...
<?php
     ...
     * - https://developers.popbill.com/reference/bizinfocheck/php/common-api/point#GetSettleResult
     */
    ...
    try {
        $result = $BizInfoCheckService->GetSettleResult($CorpNum, $settleCode, $UserID);
    }
