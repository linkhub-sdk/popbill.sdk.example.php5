 ...
 * - https://developers.popbill.com/reference/bizinfocheck/php/api/point#GetRefundInfo
 */
...
try {
    $result = $BizInfoCheckService->GetRefundInfo($testCorpNum, $RefundCode, $testUserID);
