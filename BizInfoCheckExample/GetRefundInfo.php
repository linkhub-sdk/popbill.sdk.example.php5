 ...
 * - https://developers.popbill.com/reference/bizinfocheck/php/common-api/point#GetRefundInfo
 */
...
try {
    $result = $BizInfoCheckService->GetRefundInfo($CorpNum, $RefundCode, $UserID);
