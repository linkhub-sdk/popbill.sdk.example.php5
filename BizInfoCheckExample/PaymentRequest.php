...
<?php
    /**
     * 무통장 입금을 신청합니다.
     * - https://developers.popbill.com/reference/bizinfocheck/php/common-api/point#PaymentRequest
     */
    ...
    try {
        $result = $BizInfoCheckService->PaymentRequest($CorpNum, $paymentForm, $UserID);
        $code = $result->code;
