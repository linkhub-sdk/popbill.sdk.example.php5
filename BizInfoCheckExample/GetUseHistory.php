...
<?php
    /**
     * 포인트 사용내역을 확인합니다.
     * - https://developers.popbill.com/reference/bizinfocheck/php/common-api/point#GetUseHistory
     */
    ...
    try	{
        $result = $BizInfoCheckService->getUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
    }
