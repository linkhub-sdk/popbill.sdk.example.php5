...
<?php
     ...
     * - https://developers.popbill.com/reference/bizinfocheck/php/common-api/point#GetRefundHistory
     */
    ...
    try	{
        $result = $BizInfoCheckService->getRefundHistory($CorpNum, $Page, $PerPage, $UserID);
    }
