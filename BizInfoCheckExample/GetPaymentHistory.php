...
<?php
     ...
     * - https://developers.popbill.com/reference/bizinfocheck/php/common-api/point#GetPaymentHistory
     */
    ...
    try	{
        $result = $BizInfoCheckService->getPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
    }
