...
<?php
    ...
    try {
        $receiptNum = $MessagingService->SendMMS($CorpNum, $Sender, $Subject, $Content, $Messages, $FilePaths, $ReserveDT, $adsYN, $UserID, $senderName, $SystemYN, $RequestNum);
    }
