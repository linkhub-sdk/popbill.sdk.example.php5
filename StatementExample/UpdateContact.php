...
<?php 
	...
	$ContactInfo->searchAllAllowYN = true;		# 전체조회여부, false-개인조회, true-전체조회
	$ContactInfo->mgrYN = false;				# 관리자권한 여부

	try {
		$result = $StatementService->UpdateContact($testCorpNum, $ContactInfo, $testUserID);
		$code = $result->code;
