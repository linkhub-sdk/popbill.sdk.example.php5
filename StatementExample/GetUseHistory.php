...
<?php
     ...
     * - https://developers.popbill.com/reference/statement/php/common-api/point#GetUseHistory
     */
    ...
    try	{
        $result = $StatementService->getUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
    }
