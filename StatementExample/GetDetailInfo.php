...
<?php
    ...
    try {
        $result = $StatementService->GetDetailInfo($CorpNum, $itemCode, $MgtKey, $UserID);
    }
        ...
        <div id="content">
            ...
            <fieldset class="fieldset1">
                ...
                <ul>
                    ...
                    ?>
                        <li>itemCode (전자명세서 문서 유형) : <?php echo $result->itemCode ?> </li>
                        ...
                        <li>senderContactName (발신자 성명) : <?php echo $result->senderContactName ?> </li>
                        ...
                        <li>receiverContactName (수신자 성명) : <?php echo $result->receiverContactName ?> </li>
                        ...
                        <li>receiverFAX (수신자 팩스번호) : <?php echo $result->receiverFAX ?> </li>
                        <li>businessLicenseYN (사업자등록증 첨부여부) : <?php echo $result->businessLicenseYN ? 'true' : 'false'  ?> </li>
                        <li>bankBookYN (통장사본 첨부여부) : <?php echo $result->bankBookYN ? 'true' : 'false'  ?> </li>
                        <li>smssendYN (문자 자동전송 여부) : <?php echo $result->smssendYN  ? 'true' : 'false' ?> </li>
                    <?php
