...
/**
 * 환불 신청의 상태를 확인합니다.
 * - https://developers.popbill.com/reference/statement/php/api/point#GetRefundResult
 */
...
try {
    $result = $StatementService->GetRefundResult($testCorpNum, $RefundCode, $testUserID);
