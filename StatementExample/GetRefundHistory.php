...
<?php
     ...
     * - https://developers.popbill.com/reference/statement/php/common-api/point#GetRefundHistory
     */
    ...
    try	{
        $result = $StatementService->getRefundHistory($CorpNum, $Page, $PerPage, $UserID);
    }
