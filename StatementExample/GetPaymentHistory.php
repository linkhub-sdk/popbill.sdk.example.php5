...
<?php
     ...
     * - https://developers.popbill.com/reference/statement/php/common-api/point#GetPaymentHistory
     */
    ...
    try	{
        $result = $StatementService->getPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
    }
