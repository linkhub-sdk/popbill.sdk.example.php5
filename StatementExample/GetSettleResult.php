...
<?php
     ...
     * - https://developers.popbill.com/reference/statement/php/common-api/point#GetSettleResult
     */
    ...
    try {
        $result = $StatementService->GetSettleResult($CorpNum, $settleCode, $UserID);
    }
