...
<?php
    /**
     * 무통장 입금을 신청합니다.
     * - https://developers.popbill.com/reference/httaxinvoice/php/common-api/point#PaymentRequest
     */
    ...
    try {
        $result = $HTTaxinvoiceService->PaymentRequest($CorpNum, $paymentForm, $UserID);
        $code = $result->code;
