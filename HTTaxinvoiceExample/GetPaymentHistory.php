...
<?php
     ...
     * - https://developers.popbill.com/reference/httaxinvoice/php/common-api/point#GetPaymentHistory
     */
    ...
    try	{
        $result = $HTTaxinvoiceService->getPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
    }
