...
<?php
     ...
     * - https://developers.popbill.com/reference/httaxinvoice/php/common-api/point#GetRefundHistory
     */
    ...
    try	{
        $result = $HTTaxinvoiceService->getRefundHistory($CorpNum, $Page, $PerPage, $UserID);
    }
