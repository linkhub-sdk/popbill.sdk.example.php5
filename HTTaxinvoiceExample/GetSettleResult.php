...
<?php
     ...
     * - https://developers.popbill.com/reference/httaxinvoice/php/common-api/point#GetSettleResult
     */
    ...
    try {
        $result = $HTTaxinvoiceService->GetSettleResult($CorpNum, $settleCode, $UserID);
    }
