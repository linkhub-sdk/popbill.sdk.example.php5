 ...
 * - https://developers.popbill.com/reference/httaxinvoice/php/common-api/point#GetRefundInfo
 */
...
try {
    $result = $HTTaxinvoiceService->GetRefundInfo($CorpNum, $RefundCode, $UserID);
