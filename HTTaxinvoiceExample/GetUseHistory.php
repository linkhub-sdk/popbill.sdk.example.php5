...
<?php
     ...
     * - https://developers.popbill.com/reference/httaxinvoice/php/common-api/point#GetUseHistory
     */
    ...
    try	{
        $result = $HTTaxinvoiceService->getUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
    }
