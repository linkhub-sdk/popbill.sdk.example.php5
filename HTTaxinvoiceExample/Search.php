...
<?php
    ...
    // 종사업장 식별번호 유무 (null , "0" , "1" 중 택 1)
    // - null = 전체 , 0 = 없음, 1 = 있음
    $TaxRegIDYN = null;

    // 종사업장 식별번호의 주체 ("S" , "B" , "T" 중 택 1)
    // └ S = 공급자 , B = 공급받는자 , T = 수탁자
    // - 미입력시 전체조회
    $TaxRegIDType = null;
                ...
                <li>message (응답 메시지) : <?php echo $message ?></li>
                    ...
                    for ( $i = 0; $i < Count ( $response->list ); $i++ ) {
                        ...
                        <fieldset class="fieldset2">
                            ...
                            <ul>
                                <li>ntsconfirmNum (전자세금계산서 국세청승인번호) : <?php echo $response->list[$i]->ntsconfirmNum ; ?></li>
                                ...
                                <li>invoiceType (전자세금계산서 유형) : <?php echo $response->list[$i]->invoiceType ; ?></li>
                                ...
                                <li>purchaseDate (품목1의 거래일자) : <?php echo $response->list[$i]->purchaseDate ?></li>
                                <li>itemName (품목1의 품명) : <?php echo $response->list[$i]->itemName ?></li>
                                <li>spec (품목1의 규격) : <?php echo $response->list[$i]->spec ?></li>
                                <li>qty (품목1의 수량) : <?php echo $response->list[$i]->qty ?></li>
                                <li>unitCost (품목1의 단가) : <?php echo $response->list[$i]->unitCost ; ?></li>
                                <li>supplyCost (품목1의 공급가액) : <?php echo $response->list[$i]->supplyCost ; ?></li>
                                <li>tax (품목1의 세액) : <?php echo $response->list[$i]->tax ; ?></li>
                                <li>remark (품목1의 비고) : <?php echo $response->list[$i]->remark ; ?></li>

                                <li>invoicerCorpNum (공급자 사업자번호) : <?php echo $response->list[$i]->invoicerCorpNum ; ?></li>
                                <li>invoicerTaxRegID (공급자 종사업장 식별번호) : <?php echo $response->list[$i]->invoicerTaxRegID ; ?></li>
                                ...
                                <li>invoicerEmail (공급자 담당자 메일) : <?php echo $response->list[$i]->invoicerEmail ; ?></li>
                                ...
                                <li>invoiceeTaxRegID (공급받는자 종사업장 식별번호) : <?php echo $response->list[$i]->invoiceeTaxRegID ; ?></li>
                                ...
                                <li>invoiceeEmail1 (공급받는자 담당자 메일) : <?php echo $response->list[$i]->invoiceeEmail1 ; ?></li>
                                ...
                                <li>tursteeTaxRegID (수탁자 종사업장 식별번호) : <?php echo $response->list[$i]->trusteeTaxRegID ; ?></li>
                                ...
                                <li>trusteeEmail (수탁자 담당자 메일) : <?php echo $response->list[$i]->trusteeEmail ; ?></li>
