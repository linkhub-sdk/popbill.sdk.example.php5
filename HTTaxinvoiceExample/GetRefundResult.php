...
/**
 * 환불 신청의 상태를 확인합니다.
 * - https://developers.popbill.com/reference/httaxinvoice/php/api/point#GetRefundResult
 */
...
try {
    $result = $HTTaxinvoiceService->GetRefundResult($testCorpNum, $RefundCode, $testUserID);
