            ...
            <fieldset class="fieldset1">
                ...
                <ul>
                    ...
                    ?>
                                ...
                                <li>customerName (구매자(고객) 성명) : <?php echo $result->customerName ?></li>
                                ...
                                <li>ntsresultCode (국세청 결과코드) : <?php echo $result->ntsresultCode ?></li>
                                <li>ntsresultMessage (국세청 결과메시지) : <?php echo $result->ntsresultMessage ?></li>
