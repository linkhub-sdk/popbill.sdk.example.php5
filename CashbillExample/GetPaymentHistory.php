...
<?php
     ...
     * - https://developers.popbill.com/reference/cashbill/php/common-api/point#GetPaymentHistory
     */
    ...
    try	{
        $result = $CashbillService->getPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
    }
