...
<?php
     ...
     * - https://developers.popbill.com/reference/closedown/php/common-api/point#GetUseHistory
     */
    ...
    try	{
        $result = $ClosedownService->getUseHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $Order, $UserID);
    }
