...
/**
 * 환불 신청의 상태를 확인합니다.
 * - https://developers.popbill.com/reference/closedown/php/api/point#GetRefundResult
 */
...
try {
    $result = $ClosedownService->GetRefundResult($testCorpNum, $RefundCode, $testUserID);
