...
<?php
     ...
     * - https://developers.popbill.com/reference/closedown/php/common-api/point#GetPaymentHistory
     */
    ...
    try	{
        $result = $ClosedownService->getPaymentHistory($CorpNum, $SDate, $EDate, $Page, $PerPage, $UserID);
    }
