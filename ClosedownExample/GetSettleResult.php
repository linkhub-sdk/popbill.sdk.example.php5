...
<?php
     ...
     * - https://developers.popbill.com/reference/closedown/php/common-api/point#GetSettleResult
     */
    ...
    try {
        $result = $ClosedownService->GetSettleResult($CorpNum, $settleCode, $UserID);
    }
