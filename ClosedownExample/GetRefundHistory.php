...
<?php
     ...
     * - https://developers.popbill.com/reference/closedown/php/common-api/point#GetRefundHistory
     */
    ...
    try	{
        $result = $ClosedownService->getRefundHistory($CorpNum, $Page, $PerPage, $UserID);
    }
